...
class PeftType(str, enum.Enum):
    ...
    PROMPT_TUNING_LORA = "PROMPT_TUNING_LORA"
    PROMPT_TUNING_LODIM = "PROMPT_TUNING_LODIM"
    PROMPT_TUNING_DPT = "PROMPT_TUNING_DPT"
...
class PeftConfigMixin(PushToHubMixin):
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        output_dict = {k: v for k, v in self.__dict__.items() if k != 'pretrained_embedding'} # ensure that for lowdim pt, the tensor in config is not saved
