""" This code is based on the code from (https://github.com/AkariAsai/ATTEMPT)."""
...
class NaturalQuestions(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('lucadiliello/naturalquestionsshortqa', split=split)
...
class HotpotQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('lucadiliello/hotpotqa', split=split)
...
class SearchQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('lucadiliello/searchqa', split=split)
...
class NewsQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('lucadiliello/newsqa', split=split)
