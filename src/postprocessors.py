...
# Postprocessor for Decoder models
# class PostProcessor(abc.ABC): 
#     """Postprocess the predictions and labels to make them suitable for
#     evaluation."""
#     def __init__(self, tokenizer, ignore_pad_token_for_loss):
...
#     def truncate_at_pad(self, text, eos_token):
#         """Truncate text at the first occurrence of the EOS token."""
...
#         # Remove special tokens and truncate at pad
#         decoded_preds = [
#             self.remove_special_tokens(self.truncate_at_pad(pred, self.tokenizer.pad_token)).strip()
